  ...
  return (
    <div className={`min-h-screen flex flex-col transition-colors duration-500 ${
      ...
      <main className="flex-grow flex items-center justify-center p-4 z-10 mt-20">
        <div className={`w-full max-w-2xl rounded-2xl shadow-2xl overflow-hidden transition-all duration-500 hover:shadow-3xl ${
          isDarkTheme 
          ...
          <div className={`p-6 transition-all duration-500 ${
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="group">
                  <label htmlFor="firstName" className={`block text-sm font-semibold mb-2 transition-colors duration-300 ${
                ...
                <div className="group">
                  <label htmlFor="lastName" className={`block text-sm font-semibold mb-2 transition-colors duration-300 ${
                    isDarkTheme ? 'text-slate-300 group-hover:text-blue-300' : 'text-slate-700 group-hover:text-blue-600'
                  }`}>
                    Last Name
                  </label>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="group">
                  <label htmlFor="phoneNumber" className={`block text-sm font-semibold mb-2 transition-colors duration-300 ${
                    isDarkTheme ? 'text-slate-300 group-hover:text-blue-300' : 'text-slate-700 group-hover:text-blue-600'
                  }`}>
                    Phone Number
                  </label>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="group">
                  <label htmlFor="dob" className={`block text-sm font-semibold mb-2 transition-colors duration-300 ${
                    isDarkTheme ? 'text-slate-300 group-hover:text-blue-300' : 'text-slate-700 group-hover:text-blue-600'
                  }`}>
                    Date of Birth
                  </label>
                ...
                <div className="group">
                  <label htmlFor="role" className={`block text-sm font-semibold mb-2 transition-colors duration-300 ${
                    isDarkTheme ? 'text-slate-300 group-hover:text-blue-300' : 'text-slate-700 group-hover:text-blue-600'
                  }`}>
                    Role
                  </label>
              ...
              {formData.role && (
                <div className="grid grid-cols-2 gap-4">
                  {formData.role === 'hr' ? (
                    <div className="group">
                      <label htmlFor="companyName" className={`block text-sm font-semibold mb-2 transition-colors duration-300 ${
                        isDarkTheme ? 'text-slate-300 group-hover:text-blue-300' : 'text-slate-700 group-hover:text-blue-600'
                      }`}>
                        Company Name
                      </label>
                    ...
                    <div className="group">
                      <label htmlFor="currentJobRole" className={`block text-sm font-semibold mb-2 transition-colors duration-300 ${
                        isDarkTheme ? 'text-slate-300 group-hover:text-blue-300' : 'text-slate-700 group-hover:text-blue-600'
                      }`}>
                        Current Job Role
                      </label>
                  ...
                  <div className="group">
                    <label htmlFor="yearsOfExperience" className={`block text-sm font-semibold mb-2 transition-colors duration-300 ${
                      isDarkTheme ? 'text-slate-300 group-hover:text-blue-300' : 'text-slate-700 group-hover:text-blue-600'
                    }`}>
                      Years of Experience
                    </label>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="group">
                  ...
                  <div className="relative">
                    ...
                    {showPasswordRules && (
                      <div className={`absolute top-full left-0 mt-2 w-72 p-4 rounded-xl shadow-2xl text-sm z-20 backdrop-blur-lg ${
                        isDarkTheme ? 'bg-slate-800/95 text-slate-300 border border-slate-600' : 'bg-white/95 text-slate-700 border border-slate-300'
                      }`}>
                        <p className="font-semibold mb-2">Password Requirements:</p>
                        <ul className="list-disc pl-4 space-y-1">
                          <li className={formData.password.length >= 8 ? 'text-green-400' : 'text-red-400'}>At least 8 characters</li>
                          <li className={/[A-Z]/.test(formData.password) ? 'text-green-400' : 'text-red-400'}>One uppercase letter</li>
                          <li className={/[a-z]/.test(formData.password) ? 'text-green-400' : 'text-red-400'}>One lowercase letter</li>
                          <li className={/\d/.test(formData.password) ? 'text-green-400' : 'text-red-400'}>One number</li>
                          <li className={/[!@#$%^&*(),.?":{}|<>]/.test(formData.password) ? 'text-green-400' : 'text-red-400'}>One special character</li>
                        </ul>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="relative">
                    ...
                    {showPasswordRules && (
                      <div className={`absolute top-full left-0 mt-2 w-72 p-4 rounded-xl shadow-2xl text-sm z-20 backdrop-blur-lg ${
                        ...
                        <ul className="list-disc pl-4 space-y-1">
                          <li className={formData.password === formData.confirmPassword && formData.password !== '' ? 'text-green-400' : 'text-red-400'}>
              ...
              {passwordErrors.length > 0 && (
                <div className={`p-3 rounded-lg ${
                  isDarkTheme ? 'bg-red-900/30 border border-red-800' : 'bg-red-50 border border-red-200'
                }`}>
                  <p className={`text-sm font-semibold ${isDarkTheme ? 'text-red-300' : 'text-red-700'}`}>
