...
export default function MySkills() {
  ...
  // Load skills directly when component mounts
  useEffect(() => {
    const loadSkills = () => {
      const mockSkills = [
        { 
  ...
  const insights = [
    {
      ...
      text: skills.length > 0 
        ? `You have ${skills.length} skills in your profile. Start verifying them to build your portfolio.`
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              ...
              >
                Manage your skills, take verification exams, and track your progress.
              </motion.p>
            </div>
            <motion.div
